...
#define MAX_JOYPAD_NUM								(32)				// ジョイパッドの最大数
...
#define DX_INPUT_PAD1								(0x0001)		// パッド  1入力
#define DX_INPUT_PAD2								(0x0002)		// パッド  2入力
#define DX_INPUT_PAD3								(0x0003)		// パッド  3入力
#define DX_INPUT_PAD4								(0x0004)		// パッド  4入力
#define DX_INPUT_PAD5								(0x0005)		// パッド  5入力
#define DX_INPUT_PAD6								(0x0006)		// パッド  6入力
#define DX_INPUT_PAD7								(0x0007)		// パッド  7入力
#define DX_INPUT_PAD8								(0x0008)		// パッド  8入力
#define DX_INPUT_PAD9								(0x0009)		// パッド  9入力
#define DX_INPUT_PAD10								(0x000a)		// パッド 10入力
#define DX_INPUT_PAD11								(0x000b)		// パッド 11入力
#define DX_INPUT_PAD12								(0x000c)		// パッド 12入力
#define DX_INPUT_PAD13								(0x000d)		// パッド 13入力
#define DX_INPUT_PAD14								(0x000e)		// パッド 14入力
#define DX_INPUT_PAD15								(0x000f)		// パッド 15入力
#define DX_INPUT_PAD16								(0x0010)		// パッド 16入力
#define DX_INPUT_PAD17								(0x0011)		// パッド 17入力
#define DX_INPUT_PAD18								(0x0012)		// パッド 18入力
#define DX_INPUT_PAD19								(0x0013)		// パッド 19入力
#define DX_INPUT_PAD20								(0x0014)		// パッド 20入力
#define DX_INPUT_PAD21								(0x0015)		// パッド 21入力
#define DX_INPUT_PAD22								(0x0016)		// パッド 22入力
#define DX_INPUT_PAD23								(0x0017)		// パッド 23入力
#define DX_INPUT_PAD24								(0x0018)		// パッド 24入力
#define DX_INPUT_PAD25								(0x0019)		// パッド 25入力
#define DX_INPUT_PAD26								(0x001a)		// パッド 26入力
#define DX_INPUT_PAD27								(0x001b)		// パッド 27入力
#define DX_INPUT_PAD28								(0x001c)		// パッド 28入力
#define DX_INPUT_PAD29								(0x001d)		// パッド 29入力
#define DX_INPUT_PAD30								(0x001e)		// パッド 30入力
#define DX_INPUT_PAD31								(0x001f)		// パッド 31入力
#define DX_INPUT_PAD32								(0x0020)		// パッド 32入力
